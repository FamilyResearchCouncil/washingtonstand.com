...
export async function getStaticProps(context) {
    ...
    await fetch(`https://api.frc.org/api/webjson/frc/script-generated/washington_stand_featured_and_top_articles.json?cached=3`)
        .then(res => res.json())
        .then(
            (result) => {
    ...
    await fetch(`https://api.frc.org/api/webjson/frc/script-generated/washington_stand_trending_list.json?cached=3`)
        .then(res => res.json())
        .then(
            (result) => {
                pageProps.trending = [];
    ...
    await fetch(`https://api.frc.org/api/webjson/frc/script-generated/washington_stand_around_the_web.json?cached=3`)
        .then(res => res.json())
        .then((result) => {
